#AVI Instances
resource "oci_core_instance" "AVI_Internal_Portal_Frontend" {
	agent_config {
	...
	create_vnic_details {
		...
		subnet_id = var.operationalportal_subnet
	}
	display_name = var.AVI_Internal_Portal_Frontend_displayname
	instance_options {
...
resource "oci_core_instance" "AVI_Backend" {
	agent_config {
		is_management_disabled = "false"
		is_monitoring_disabled = "false"
		plugins_config {
	...
	create_vnic_details {
		...
		assign_private_dns_record = "true"
		assign_public_ip = "false"
		subnet_id = var.opertionalapp_subnet
	}
	display_name = var.AVI_Backend_displayname
	instance_options {
		are_legacy_imds_endpoints_disabled = "false"
	}
	is_pv_encryption_in_transit_enabled = "true"
...
resource "oci_core_instance" "AVI_Database" {
	agent_config {
		is_management_disabled = "false"
		is_monitoring_disabled = "false"
		plugins_config {
	...
	display_name = var.AVI_Database_displayname
	instance_options {
		are_legacy_imds_endpoints_disabled = "false"
	}
	is_pv_encryption_in_transit_enabled = "true"
